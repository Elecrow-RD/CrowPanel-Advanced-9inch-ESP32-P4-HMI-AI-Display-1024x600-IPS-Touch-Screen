/**
 * @file Lesson13_RX_SX1262_Wireless_Module.ino
 ...
 *--------------------------------------------------------------*/
/**
 * @brief Copy a received radio packet into the UI buffer for later display.
 *
 * @param data Input data or destination structure, as required by the operation.
 * @param len Number of bytes available or expected.
 * @param rssi Received signal strength in dBm.
 * @param snr Received signal-to-noise ratio in dB.
 * @return None.
 * @note Called by the wireless driver after a packet passes validation.
 */
...
/**
 * @brief Enable the ESP32-P4 LDO rails required by the display and touch hardware.
 *
 * Parameters: None.
 * @return None.
...
/**
 * @brief Initialize the display panel, touch controller, and LVGL port.
 *
 * Parameters: None.
 * @return None.
 * @note Called during lesson setup before the related hardware is used.
 ...
 *--------------------------------------------------------------*/
/**
 * @brief Initialize the hardware and services needed to receive SX1262 LoRa packets and display radio measurements.
 *
 * Parameters: None.
 * @return None.
...
void setup() {
    ...
    if (err != ESP_OK) {
        MAIN_ERROR("Wireless Module RX init...");  // Halt if failed
    }
...
/**
 * @brief Continue the runtime workflow used to receive SX1262 LoRa packets and display radio measurements.
 *
 * Parameters: None.
 * @return None.
