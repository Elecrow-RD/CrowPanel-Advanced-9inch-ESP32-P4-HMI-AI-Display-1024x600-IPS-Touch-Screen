 ...
 *--------------------------------------------------------------*/
/**
 * @brief Create the LVGL labels used for temperature and humidity values.
 *
 * Parameters: None.
 * @return None.
...
/**
 * @brief Refresh the LVGL labels with the latest sensor measurements.
 *
 * @param temperature Temperature value in degrees Celsius.
 * @param humidity Relative humidity value in percent.
 * @return None.
...
/**
 * @brief Periodically read the DHT20 and update the display when data is valid.
 *
 * @param param Unused FreeRTOS task argument.
 * @return None.
 * @note Started once during setup and then scheduled continuously by FreeRTOS.
 */
 ...
 *--------------------------------------------------------------*/
/**
 * @brief Initialize the hardware and services needed to read a DHT20 sensor and display its measurements with LVGL.
 *
 * Parameters: None.
 * @return None.
...
/**
 * @brief Continue the runtime workflow used to read a DHT20 sensor and display its measurements with LVGL.
 *
 * Parameters: None.
 * @return None.
