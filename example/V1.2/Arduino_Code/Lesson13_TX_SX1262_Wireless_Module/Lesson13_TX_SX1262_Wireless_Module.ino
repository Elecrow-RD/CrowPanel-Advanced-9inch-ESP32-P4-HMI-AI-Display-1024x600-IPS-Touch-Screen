/**
 * @file Lesson13_TX_SX1262_Wireless_Module.ino
...
/**
 * @brief Ask the SX1262 driver to transmit the next packet when it is ready.
 *
 * @param param Unused FreeRTOS task argument.
 * @return None.
 ...
 *--------------------------------------------------------------*/
/**
 * @brief Initialize the hardware and services needed to transmit numbered packets with the SX1262 LoRa radio.
 *
 * Parameters: None.
 * @return None.
...
/**
 * @brief Continue the runtime workflow used to transmit numbered packets with the SX1262 LoRa radio.
 *
 * Parameters: None.
 * @return None.
