/**
 * @file Lesson14_TX_nRF2401_Wireless_RF_Module.ino
 ...
 *--------------------------------------------------------------*/
/**
 * @brief Create the LVGL label that displays the transmit counter.
 *
 * Parameters: None.
 * @return None.
...
/**
 * @brief Refresh the transmit counter label from the radio driver state.
 *
 * @param param Unused FreeRTOS task argument.
 * @return None.
 * @note Started during setup and then scheduled periodically by FreeRTOS.
 */
...
/**
 * @brief Periodically request transmission of the next nRF24 packet.
 *
 * @param param Unused FreeRTOS task argument.
 * @return None.
 * @note Started during setup and then scheduled continuously by FreeRTOS.
 */
 ...
 *--------------------------------------------------------------*/
/**
 * @brief Initialize the hardware and services needed to transmit packets with the nRF24 radio.
 *
 * Parameters: None.
 * @return None.
...
void setup() {
    ...
    esp_err_t err = nrf24_tx_init();
    if (err != ESP_OK) {  // Check error
        MAIN_ERROR("nRF24L01 Wireless Module init...");  // Handle failure
    }
...
/**
 * @brief Continue the runtime workflow used to transmit packets with the nRF24 radio.
 *
 * Parameters: None.
 * @return None.
