...
void app_main(void)
{
    ...
    if (lvgl_port_lock(0)) {
        ...
        lv_obj_set_size(ui_home, H_size, V_size);
        ...
        lv_obj_set_width(temperature_label_, H_size);
        ...
        lv_obj_set_width(weather_label_, H_size);
        ...
        lv_obj_set_width(date_label_, H_size);
        ...
        lv_obj_set_width(week_label_, H_size);
